function calcular() {
  ...
  document.getElementById("message").innerHTML = `Olá! Você percorreu ${distancia}km em ${tempo}horas. Sua velocidade média foi de ${velocidadeMedia}km/h, você teve um gasto calorico de ${gastoCalorico}`;
}
